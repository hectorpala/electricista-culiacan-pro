#!/usr/bin/env bash
# Checker DETERMINISTA de SECRETOS para electricistaculiacanpro.mx.
...
RULES=(
  ...
  # Formato ACTUAL de client secret de Google.
...
# VERIFICACIÓN CIEGA: 0 archivos barridos = git falló, no un repo sin archivos.
