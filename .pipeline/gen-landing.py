...
{
  "skeleton": "servicios/electricista-cerca-de-mi/index.html",   # ruta relativa a la raíz
  "output":   "servicios/electricista-zona-X-culiacan/index.html",
  "replacements": [
     {"old": "<title>...</title>", "new": "<title>...</title>", "n": 1},
     {"old": "electricista-cerca-de-mi", "new": "electricista-zona-x-culiacan", "n": 8}
     ...
  ]
}
...
def main():
    ...
    # Guardas anti-fuga genéricas del sitio
    low = s.lower()
    for bad in ("plomero", "gtm-w75crtx5", "info@plomero"):
        if bad in low:
