...
bloquean. check-produccion.mjs NO se incluye aquí: valida producción en vivo
(post-deploy), su lugar es el pipeline nocturno, no el gate pre-merge.
...
# check-estructura-sitio: existía y emitía el contrato pero jamás corría en el gate.
