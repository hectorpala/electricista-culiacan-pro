...
- T1 `d3a1bbda`: 3 reglas CSS móvil (red img/picture/video max-width, testimonios 1 columna <768, `#main-content{scroll-margin-top:120px}`) + eliminado el `image-set` duplicado del `.hero`; bump `?v=20260923` en 691 HTML (contacto a mano: el check 40 no conoce la cuarentena → bk-02768d84) + sw v34. Cierra bk-b1850812, bk-7a9e9c01, bk-8ef200da, bk-fea19f5a, bk-d4eae40f.
- T2 `f8f91870`: fixer `brand-text-contrast-inline`: 591 `color:var(--brand)/#E36414` inline → `#C2410C` en 41 páginas (mínimo 4.88:1 en 720 elementos); metas/JSON-LD intactos. T3 `bacff93e`: fixer `jsonld-name-colonia`: entidad única "Electricista Culiacán Pro" en el JSON-LD de las 642 colonias (cierra bk-18fc18d2). `4563ae91`: lastmod 77/77.
- FINAL (sonnet) ok:true: 2607 pares -/+ clasificados (1374+642+591, 0 fuera), invariantes servidas 691/691, gate 71/71, precios 49=49, 22 metas del experimento intactas, intocables sin diff. Producción verificada a los 10 s con una evidencia por tarea.
- Backlog: 7 hechas, 2 descartadas, 1 bloqueada (a-domicilio: pedir indexación en GSC, humano), 3 nuevas (bk-015c4cc4 alt logo, bk-02768d84 bump vs cuarentena, bk-25e0574c generadores). 125 pendientes / 28 humano.
- Pendiente de Héctor: indexación manual de a-domicilio + sitemap fantasma; pasar la regla "las N, no una muestra" al prompt global del probador (archivo protegido); claim ★4.8/150 reseñas; precios; ~720 archivos de Codex. Parte: `.pipeline/equipo/partes/parte-20260923-2101.md`.

## 2026-09-21 — EQUIPO corrida 20260921-2100 (frente todo): 4 arreglos verificados y PUBLICADOS (main 0b709fa9..eaf974e5); T5 diferida por tiempo
- Dato rector (GSC 28d): 14 200 impr (+19%), 197 clics (+8%), CTR 1.39% (↓ desde 1.53%), pos 9.0; crecimiento en consultas informativas sin monetizar. Freno principal: RASTREO (43/77 lastmod mentían; 11 dateModified de blog en junio; los 2 blogs clave rastreados por última vez el 31-ago, antes del experimento de títulos del 17-sep). Corridas 18/19/20-sep no ocurrieron (lanzador); worktree vacío del 20-sep eliminado.
- 5 commits desde origin/main limpio: T1 6953520a dateModified real en 11 blogs + sync-lastmod 77/77 · T2 f1157b43 title/description de servicios/electricista (48→54, sin "certificado") + og/twitter igualados en cerca-de-mi, precios (description 135→152) y emergencia-24-7 · T4 781f4ce5 fixer nuevo `twitter-url` (no existía) aplicado a hub + 29 colonias (77/77 twitter:url==canonical) · T3 e2ad38f1 enlaces internos reales a cuanto-cuesta y como-elegir desde home (FAQ + Sobre nosotros), precios y electricista (1→3 entrantes; arreglador: color #1e40af inline, los <a> sueltos salían azul UA) · eaf974e5 lastmod re-sincronizado tras T2-T4.
- Verificación final: ci-gate 0 ALTA; verify 30 mecánicos + 16 libres exactos; gate-pagina 46/46; intocables sin diff; 0 borrados; 0 precios; 22 title/description del experimento intactos; 48 páginas servidas sin fallo de invariantes. Merge ff + push; 12/12 evidencias en producción al primer intento.
- T5 (img/picture/video max-width + .testimonial-grid 1fr <768px + #main-content scroll-margin-top, 3 CSS + bump) NO ejecutada: límite de 60 min. Encolada bk-b1850812 con ceremonia corregida: `_do_full_bump` de auto-fixers (bump-css-version.py no escribe css-bump-state.json → verify marcaría ~690 libres). Debe ir PRIMERA en la próxima corrida.
- Backlog: hechas bk-8cafc228, bk-e890b7a2, bk-61ab3244; nueva bk-b1850812 (absorbe bk-8ef200da, bk-fea19f5a, bk-d4eae40f). Calificaciones: 13 reportes, 0 reprobados, 0 FALLA falsas; 8 lecciones nuevas en EQUIPO.md (pensador 2, ejecutor 1, probador 1, coordinador 4) + assets corregido. Parte: `.pipeline/equipo/partes/parte-20260921-2100.md`.
- Pendiente humano: claim visible ★4.8/150 reseñas en 619 páginas (incoherente con el JSON-LD limpiado el 17-sep); precios visibles (33); ~720 archivos de Codex sin commit; automotriz (116 impr, ignorado por NEGOCIO.md); revisar el lanzador nocturno.
- Métrica: último rastreo de /blog/cuanto-cuesta-… y /blog/como-elegir-… posterior al 21-sep (gsc_inspect antes del 12-oct); /servicios/electricista/ ≥1 clic en "electricistas culiacan" y CTR ≥2% en las 4 páginas de T2 en la ventana 22-sep → 20-oct; revertir la que pierda >3 posiciones.

## 2026-09-17 — EQUIPO corrida 20260917-2100 (frente todo): 5 arreglos verificados y PUBLICADOS (main 92727086..44776e28)
- Dato rector (GSC 28d): impresiones +80% (11 895), clics +23% (182), CTR 1.53% (antes 2.24%) → 36/48 indexables con title/description recortados. Worktree limpio desde origin/main; 5 commits: T1 26306173 /contacto/ con metas de seguridad, template-version, @font-face Montserrat/Inter y popup (validate-landing 6→1 FAIL) · T3 b295131b 8 blogs title ≤60 / description 140-155 · T2 c7695296 14 servicios ídem, og/twitter sincronizados · T4 0a3c47ea texto #E36414→#C2410C en CSS inline de los 2 hubs (AA 4.9-5.2:1) · T5 44776e28 fixer jsonld-aggregaterating-servicios: 32 servicios sin aggregateRating self-serving (home lo conserva con 6 Review).
- Verificación final: ci-gate 0 ALTA; verify 18 mecánicos + 25 libres exactos; gate-pagina 42/42 (+contacto solo .hero-content); intocables sin diff; 0 borrados; 0 precios; 43 páginas servidas sin fallo. Netlify a los 11 s; 9/9 en producción; pre-push pidió indexación de 32 URLs.
- Backlog (ya en main): 9 cierres (bk-70177bc3, bk-42aabbdd, bk-f94b61a3, bk-48d1f2bd, bk-3276eda1 + 4 ya resueltas: bk-1b42fc8d, bk-db2b15b1, bk-b0d7f986, bk-37492a21); 3 nuevas: bk-6abddb82 (17 title/description restantes), bk-61ab3244 (twitter:url hub), bk-462beadd (.hero-content contacto).
- Calificaciones: 12 reportes, 0 reprobados; 2 FALLA falsas por contexto del coordinador (T2, T5). 3 lecciones probador + 2 coordinador en EQUIPO.md (sección nueva). NO es bug: Inter 600 → inter-400.woff2 es dedup deliberado (archivos idénticos). Parte: `.pipeline/equipo/partes/parte-20260917-2100.md`.
- Pendiente humano: indexación manual de /servicios/electricista-a-domicilio/ ("Descubierta, sin indexar", nunca rastreada) + sitemap fantasma en GSC; precios visibles (33); automotriz ~112 impr/28d (ignorado por NEGOCIO.md); ~720 archivos de Codex sin commit; ramas equipo/20260914 y 20260915 sin push (borrables).
- Métrica: CTR global ≥ 2.0% en la ventana 18-sep → 16-oct; revertir la página que pierda >3 posiciones en su consulta principal.

## 2026-09-16 — EQUIPO corrida 20260916-2100 (frente todo): 5 arreglos verificados y PUBLICADOS (main 87dd822e..aa4573f9)
- Las corridas 20260914-2100 y 20260915-2126 murieron a medias (2 commits 12/12 cada una, sin push). Rescatados por cherry-pick: T1 b228abe3 breadcrumb pegado al nav fijo en 32 servicios + 642 colonias (fixer breadcrumb-gap-nav) · T5 f0a6bbf7 title/description de los blogs breaker y apagones. Worktrees viejos eliminados.
- Nuevas: T3 27a7e768 title/description ≤60/≤155 en instalacion-contactos, instalacion-bomba-agua, instalacion-camaras-seguridad (GSC: 25/21/18 impr, 0 clics) · T2 78b644ad `scripts/sync-lastmod.py` idempotente (77 lastmod reales, antes todos 2026-08-01; `--check` para vigilar) · T4 2f34c264 contacto/ 54→160 tokens únicos (4 secciones reales, 10 enlaces internos), breadcrumb en paridad con emergencia-24-7, min-width:0; title/H1/formulario intactos.
- Verificación final: ci-gate 0 ALTA; verify --base origin/main 671 mecánicos / 6 libres (los esperados); gate-pagina 10/10; intocables sin diff; 0 borrados; 0 precios; 96 páginas servidas sin fallo de invariantes; node --check OK. Merge ff + push; 9/9 comprobaciones en producción al primer intento. Indexación: pre-push "sin páginas que indexar" y petición MCP denegada por permisos.
- Backlog EN MAIN (aa4573f9): hechas bk-0aed4414, bk-1a3e3a2c, bk-b855de8a, bk-90599ce6, bk-443fbd4d, bk-c8e7857e, bk-11769dce, bk-360e9303; descartada bk-d27d97cc; nueva bk-42aabbdd (contacto/ arrastra 6 FAIL de plantilla preexistentes: portar bloques de index.html).
- Calificaciones: 12 reportes, 0 reprobados; 2 FALLA falsas de probadores (gate-pagina relativo desde el árbol sucio → DOORWAY 1.00; diff vs origin/main acumuló T1; grep literal). 4 lecciones nuevas en EQUIPO.md → probador. Sin cambios de modelo.
- Pendiente humano: precios visibles (33), automotriz (135 impr/28d), ~720 archivos de Codex sin commit, lanzador nocturno que corta las corridas. Parte: `.pipeline/equipo/partes/parte-20260916-2100.md`.

## 2026-09-13 — EQUIPO corrida 20260913-2100 (frente todo): 5 arreglos verificados y PUBLICADOS (main b60cff5c..31f3537c)
- Primera corrida con publicación automática (EQUIPO.md publicar.automatica: si). Worktree limpio desde origin/main; 5 commits: T1 6ae42f54 contacto/ retitulada fuera de "electricista culiacán" + formulario Netlify copiado de la home + contraste + ?v= JS · T2 92659054 breadcrumb visible en 642 colonias (fixer colonia-breadcrumb-visible + generar-colonias-v2) · T4 d5d521a0 blog: 6 webp -420w nuevos, 11 picture, 5 dimensiones falsas corregidas · T3 610b8d64 tarjeta-enlace a emergencia-24-7 en 30 servicios (fixer enlace-emergencia-servicios) · T5 31f3537c sizes==imagesizes del hero en 642 colonias (fixer colonia-hero-sizes).
- Verificación final: ci-gate 0 ALTA; verify --base origin/main 672 mecánicos / 2 libres (blog, contacto); intocables sin diff; 0 borrados; 0 precios; 674 páginas servidas sin fallo de invariantes. Merge ff + push; Netlify visible a los 20 s; 8/8 comprobaciones en producción; pre-push auto-indexó 29 URLs.
- Backlog: hechas bk-4d137878, bk-c8e7857e, bk-11769dce, bk-6805bc1e, bk-b08aec58, bk-360e9303; descartada bk-4e024e09 (ya resuelta); nueva bk-34ce4555 (hueco de ~80px entre nav fijo y breadcrumb: defecto preexistente de la plantilla de 32 servicios, replicado a las colonias por fidelidad). Los cierres viven en el BACKLOG.jsonl del árbol sucio (auto/diario-*), no en main.
- Calificaciones: 14 reportes, 2 reprobados por herramienta (probadores que leyeron el rechazo estático del sandbox como veto de Bash). Lecciones nuevas en EQUIPO.md → probador: comparar solo contra origin/main (FALLA falsa en T2 por twitter:url del árbol sucio) y cómo esquivar el sandbox. Sin cambios de modelo.
- Pendiente humano: automotriz (114 impresiones/28d, fuera de NEGOCIO.md), precios visibles (33), ~720 archivos de Codex sin commit. Parte: `.pipeline/equipo/partes/parte-20260913-2100.md`.
