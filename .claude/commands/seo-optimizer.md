...
/seo-optimizer electricista-24-horas/index.html
/seo-optimizer servicios/instalacion-electrica/index.html
```
...
- **Variaciones semánticas:**
  ...
  - Ejemplo: "electricista" → "electricidad", "electricistas", "eléctrico"

**Output:**
```
✅ Keywords
  • Keyword principal: "electricista 24 horas"
  • Densidad: 1.2% (8 menciones en 667 palabras) ✓
  • Posición:
    ✅ H1: "Electricista 24 Horas en Culiacán"
    ✅ Title (posición 0): "Electricista 24 Horas Culiacán..."
    ✅ Meta description (posición 12)
    ✅ Primera frase del contenido
    ✅ URL: /electricista-24-horas/
  • Variaciones: "electricista", "electricidad 24h", "electricista nocturno" (3)
```

O si hay problemas:
```
⚠️ Keywords
  • Keyword principal: "electricista urgente"
  • Densidad: 0.3% (2 menciones en 667 palabras) ❌ BAJA
  • Posición:
    ✅ H1: "Electricista Urgente en Culiacán"
    ❌ Title no contiene keyword (tiene "Electricidad rápida...")
    ✅ Meta description
    ❌ No aparece en primeras 100 palabras
    ✅ URL: /electricista-urgente/

💡 Recomendación:
  - Agregar 3-4 menciones más de "electricista urgente"
  - Actualizar title: "Electricista Urgente Culiacán 24/7..."
...
✅ Meta Tags
  • Title: 58 caracteres ✓
    "Electricista 24 Horas Culiacán | Emergencias | Electricista Pro"
  • Description: 142 caracteres ✓
    "Electricista 24 horas en Culiacán. Llegamos en 15-30 min. WhatsApp 667-392-2273"
  • Canonical: ✓ https://electricistaculiacanpro.mx/electricista-24-horas/
...
✅ JSON-LD Schemas (5 schemas válidos)
  ...
  3. Service ✓
     • serviceType: "Electricidad 24 Horas"
     • provider: ✓
     • areaServed: ✓ Culiacán
...
⚠️ JSON-LD Schemas (3 válidos, 1 con errores)
  ...
  2. LocalBusiness ⚠️
     ...
     • address: ✓
     • telephone: ✓
     • geo: ❌ FALTA ← Crítico para "electricista cerca de mí"
...
✅ Imágenes (5 imágenes analizadas)
  ...
  1. logo-electricista-culiacan-pro.webp ✓
     • Alt: "Electricista Culiacán Pro - Logo empresa electricidad" ✓
     • Formato: WebP ✓
     • Lazy: No (es LCP) ✓
     • Dimensiones: 512×512 ✓
     • Tamaño: 16KB ✓

  2. hero-electricista-24-horas.webp ✓
     • Alt: "Electricista profesional reparando emergencia eléctrica 24 horas" ✓
     • Formato: WebP ✓
     • fetchpriority: high ✓
     • Dimensiones: 1200×800 ✓
     • Tamaño: 85KB ✓

  3. instalacion-electrica.webp ✓
     • Alt: "Instalación eléctrica profesional" ✓
     • Formato: WebP ✓
     • Lazy: ✓
     • Dimensiones: 800×800 ✓

  4. servicio-cableado.jpg ⚠️
     • Alt: ✓ "Cableado eléctrico profesional"
...
💡 Recomendaciones:
  1. Convertir servicio-cableado.jpg → WebP (-60% tamaño)
  2. Agregar width/height a servicio-cableado
  3. Optimizar servicio-cableado: 245KB → <100KB
```
...
✅ Estructura HTML
  ...
  Headings:
  • H1 (1): "Electricista 24 Horas en Culiacán" ✓
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  Análisis SEO: electricista-24-horas/index.html
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
🟠 ALTO (P1) - Próxima sesión
  ...
  2. Convertir servicio-cableado.jpg a WebP
     Impacto: Medio (reduce LCP ~150ms)
     Esfuerzo: 2 min
     Acción: cwebp servicio-cableado.jpg -o servicio-cableado.webp -q 85
...
🟡 MEDIO (P2) - Cuando tengas tiempo
  ...
  4. Agregar width/height a servicio-cableado
  ...
  5. Aumentar keyword density 0.8% → 1.2%
     Impacto: Bajo
     Esfuerzo: 5 min
     Acción: Agregar 2-3 menciones naturales de "electricista 24 horas"
...
```
✅ Mejoras implementadas en electricista-24-horas/index.html

Cambios realizados:
  • Agregado og:image (1200×630)
  • Agregado Twitter Cards (4 meta tags)
  • Agregado width/height a servicio-cableado.jpg
  • Agregado lazy loading a 3 imágenes

Backup creado: electricista-24-horas/index.html.backup-seo
...
```
Usuario: /seo-optimizer electricista-urgente/index.html
...
```
Usuario: /seo-optimizer servicios/instalacion-panel-electrico/index.html
