...
5. **Confirma producción** - Valida que los cambios estén live en electricistaculiacanpro.mx
...
- **feat** - Nueva funcionalidad, landing page, sección completa
  - Ejemplo: "feat(landing): nueva página electricista-de-emergencia con SEO optimizado"
...
- `landing` - Landing pages (/electricista-24-horas/, /electricista-cerca-de-mi/)
...
Claude:
📦 Cambios detectados:
  A electricista-24-horas/index.html
  A assets/images/emergencia-hero.webp
  M sitemap.xml

💬 Commit message:
  feat(landing): nueva página electricista-24-horas con SEO optimizado

  - Keyword: "electricista 24 horas" (1,800 búsquedas/mes)
  - JSON-LD completo (Service + LocalBusiness + FAQ)
  - 10 FAQs únicas sobre emergencias eléctricas
  - Hero optimizado con imagen WebP
  - Actualizado sitemap.xml

✅ Deployment exitoso
   Commit: d4e5f6g - feat(landing): nueva página electricista-24-horas
   GitHub Actions: ✅ success
   Producción: https://electricistaculiacanpro.mx/electricista-24-horas/
```
