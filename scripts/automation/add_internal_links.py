#!/usr/bin/env python3
"""
Sistema de Internal Linking Automático para electricistaculiacanpro.mx
...
BLOG_TO_SERVICES = {
    "drenaje-tapado-senales-prevencion": [
        ("destape-de-drenajes", "servicio profesional de instalación eléctrica"),
        ("emergencia-24-7", "servicio de emergencia 24/7")
    ],
    "como-detectar-fugas-agua-casa": [
        ("deteccion-de-fugas", "servicio profesional de detección de fallas eléctricas"),
        ("reparacion-de-fugas", "reparación de cortocircuitos con garantía")
    ],
    "baja-presion-agua-causas-soluciones": [
        ("correccion-baja-presion", "servicio de corrección de baja presión"),
        ("electricista-a-domicilio", "electricista a domicilio")
    ],
    "cuanto-cuesta-cambiar-taza-bano-culiacan": [
        ("instalacion-de-sanitarios", "instalación profesional de sanitarios"),
        ("electricista-precios", "precios de servicios de electricidad")
    ],
    "cuanto-cobra-electricista-visita-culiacan": [
        ("electricista-precios", "precios de servicios de electricidad en Culiacán"),
        ("electricista-cerca-de-mi", "electricista cerca de ti")
    ],
    "como-identificar-buen-electricista-culiacan": [
        ("electricista-cerca-de-mi", "electricista profesional cerca de ti"),
        ("emergencia-24-7", "servicio confiable 24/7")
    ],
    "instalacion-tinaco-guia-compra": [
        ("electricista-a-domicilio", "instalación profesional de tinaco"),
        ("electricista-precios", "cotización de instalación")
    ],
    "problemas-comunes-plomeria-culiacan": [
        ("reparacion-de-fugas", "reparación de cortocircuitos"),
        ("destape-de-drenajes", "instalación eléctrica"),
        ("electricista-a-domicilio", "electricista profesional a domicilio")
    ],
    "cuando-llamar-electricista-profesional": [
        ("emergencia-24-7", "electricista de emergencia 24/7"),
        ("electricista-cerca-de-mi", "electricista cerca de ti")
    ],
    "cuanto-cuesta-plomeria-bano-completo-culiacan": [
        ("instalacion-de-sanitarios", "instalación de contactos"),
        ("electricista-precios", "precios de electricidad")
    ],
    ...
    "mantenimiento-boiler-noritz-checklist": [
        ...
        ("electricista-a-domicilio", "servicio a domicilio")
    ]
}
...
RELATED_ARTICLES = {
    "drenaje-tapado-senales-prevencion": [
        ...
        ("problemas-comunes-plomeria-culiacan", "Problemas comunes de electricidad en Culiacán")
    ],
    "como-detectar-fugas-agua-casa": [
        ("baja-presion-agua-causas-soluciones", "Causas de baja presión de agua"),
        ("problemas-comunes-plomeria-culiacan", "Problemas comunes de electricidad")
    ],
    "baja-presion-agua-causas-soluciones": [
    ...
    "cuanto-cuesta-cambiar-taza-bano-culiacan": [
        ("cuanto-cuesta-plomeria-bano-completo-culiacan", "Costo de electricidad de baño completo"),
        ("cuanto-cobra-electricista-visita-culiacan", "Cuánto cobra un electricista por visita")
    ],
    "cuanto-cobra-electricista-visita-culiacan": [
        ("cuanto-cuesta-cambiar-taza-bano-culiacan", "Costo de cambiar taza de baño"),
        ("como-identificar-buen-electricista-culiacan", "Cómo identificar un buen electricista")
    ],
    "como-identificar-buen-electricista-culiacan": [
        ("cuanto-cobra-electricista-visita-culiacan", "Cuánto cobra un electricista"),
        ("cuando-llamar-electricista-profesional", "Cuándo llamar a un electricista profesional")
    ],
    "problemas-comunes-plomeria-culiacan": [
    ...
    "instalacion-tinaco-guia-compra": [
        ("cuanto-cuesta-plomeria-bano-completo-culiacan", "Costo de electricidad completa"),
        ("cuando-llamar-electricista-profesional", "Cuándo llamar a un profesional")
    ],
    "mantenimiento-boiler-noritz-checklist": [
        ("cuando-llamar-electricista-profesional", "Cuándo llamar a un electricista"),
        ("problemas-comunes-plomeria-culiacan", "Problemas comunes de electricidad")
    ]
}
...
def add_contextual_link(content, keyword, url, anchor_text, context_before="", context_after=""):
    ...
    if match:
        ...
        elif '/servicios/electricista-colonias-culiacan/' in content[:1000]:
            # Estamos en colonia
            link_url = f'../../{url}/'
        else:
            # Estamos en servicio
...
def process_colonia_page(file_path, colonia_slug):
    ...
    <div style="background: #e8f4f8; padding: 20px; border-radius: 8px; margin: 24px 0; border-left: 4px solid #0066cc;">
        <p style="margin: 0; font-size: 15px; line-height: 1.6;">
            ...
            <a href="../../destape-de-drenajes/" style="color: #0066cc;">instalación eléctrica</a>,
            <a href="../../reparacion-de-fugas/" style="color: #0066cc;">reparación de cortocircuitos</a> y
            <a href="../../deteccion-de-fugas/" style="color: #0066cc;">detección de fallas eléctricas</a>.
        </p>
    </div>
"""
...
def main():
    ...
    for colonia_slug in colonias:
        file_path = Path(f"servicios/electricista-colonias-culiacan/{colonia_slug}/index.html")
        if file_path.exists():
