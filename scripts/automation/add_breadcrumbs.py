...
# Base directory
base_dir = Path("servicios/electricista-colonias-culiacan")
...
for colonia_dir in colonias:
    ...
    breadcrumb_schema = f'''        ,
        {{
            "@type": "BreadcrumbList",
            "@id": "https://electricistaculiacanpro.mx/servicios/electricista-colonias-culiacan/{colonia_slug}/#breadcrumb",
            "itemListElement": [
                {{
                    "@type": "ListItem",
                    "position": 1,
                ...
                {{
                    "@type": "ListItem",
                    "position": 4,
                    "name": "Electricista en {colonia_name}",
                    "item": "https://electricistaculiacanpro.mx/servicios/electricista-colonias-culiacan/{colonia_slug}/"
                }}
            ]
        }}'''
