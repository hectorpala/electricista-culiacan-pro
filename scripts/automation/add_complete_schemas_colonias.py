...
def create_complete_schema_graph(colonia_slug, colonia_gps):
    ...
    url = f"https://electricistaculiacanpro.mx/servicios/electricista-colonias-culiacan/{colonia_slug}/"
    ...
    graph = {
        ...
        "@graph": [
            ...
            {
                "@type": "Electrician",
                "@id": f"https://electricistaculiacanpro.mx/#business-{colonia_slug}",
                "name": f"Electricista Culiacán Pro - {colonia_name}",
                "url": url,
            ...
            {
                "@type": "Service",
                "@id": f"https://electricistaculiacanpro.mx/#service-plomeria-{colonia_slug}",
                "serviceType": f"Electricidad Residencial en {colonia_name}",
                "name": f"Electricista Certificado en {colonia_name} Culiacán",
                "description": f"Servicio profesional de electricidad en {colonia_name}, Culiacán. Reparación de fugas, instalación eléctrica, instalación de contactos, mantenimiento de tableros. Atención 24/7 con llegada rápida.",
                "provider": {
                    "@id": f"https://electricistaculiacanpro.mx/#business-{colonia_slug}"
                },
                "areaServed": {
                ...
                "image": {
                    "@type": "ImageObject",
                    "url": "https://electricistaculiacanpro.mx/assets/images/reparacion-fugas-800w.webp",
                    "width": 800,
                    "height": 800
                }
            },
            ...
            {
                "@type": "LocalBusiness",
                "@id": f"https://electricistaculiacanpro.mx/#localbusiness-{colonia_slug}",
                "name": f"Electricista Culiacán Pro - {colonia_name}",
                "description": f"Servicio profesional de electricidad en {colonia_name}, Culiacán. Atención 24/7 con llegada rápida.",
                "url": url,
            ...
            # 5. BreadcrumbList
            {
                ...
                "itemListElement": [
                    ...
                    },
                    {
                        ...
                        "position": 2,
                        "name": "Servicios",
                        "item": "https://electricistaculiacanpro.mx/#servicios"
                    },
                    {
                        "@type": "ListItem",
                        "position": 3,
                        "name": "Colonias Culiacán",
                        "item": "https://electricistaculiacanpro.mx/servicios/electricista-colonias-culiacan/"
                    },
                    {
                        "@type": "ListItem",
                        "position": 4,
                        "name": f"Electricista en {colonia_name}",
                        "item": url
                    }
                ]
            }
...
def add_schemas_to_page(colonia_slug, colonia_gps):
    ...
    index_file = Path(f"servicios/electricista-colonias-culiacan/{colonia_slug}/index.html")
...
def main():
    ...
    print(f"   3. Service (electricidad residencial)")
    print(f"   4. LocalBusiness (con GPS, email, teléfono)")
    print(f"   5. BreadcrumbList (navegación estructurada)")
    print(f"\n💡 Beneficio SEO:")
    print(f"   • Aparecer en 'electricista cerca de mí' con ubicación exacta")
